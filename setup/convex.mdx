...
<Note>
Our components can be downloaded as shadcn components and are fully customizable. You can learn how to do so [here](http://localhost:3000/setup/shadcn)
</Note>
...
<Note>
These are the most common functions you'll be using, but we also export all other functions in out JS SDK / API reference, for eg:
- `checkout`
- `attach`
And more!

Check out our API reference [here](http://localhost:3001/api-reference/core/checkout)
</Note>
